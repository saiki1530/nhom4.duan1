<main>
			...
			<div class="contact-us container-fluid no-padding">
				<div class="col-md-6 col-sm-6 col-xs-12 no-padding">
					<div class="contact-detail">
						...
						<div class="contact-info">
							...
							<p>N4 Shop, 65 Huge Street Melbourne,</p> 
							<p>2850 Australia.</p>
						</div>
						<div class="contact-info">
							<i class="icon icon-Phone2"></i>
							<a href="tel:(11)1234567890" title="Phone" class="phone">(11) 123 456 7890</a>
						</div>
						<div class="contact-info">
							<i class="icon icon-Phone2"></i>
				...
				<div class="map container-fluid no-padding">
					<div class="map-canvas" id="map-canvas-contact" data-lat="-32.559356" data-lng="149.564237" data-string="N4 Shop, 65 Huge Street Melbourne,  2850 Australia." data-zoom="12"></div>
