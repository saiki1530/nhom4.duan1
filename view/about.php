			...
			<div class="about-section container-fluid no-padding">
				...
				<div class="container">
					...
					<div class="section-header">
						<h3>About Our N4 Shop</h3>
						<p>our vision is to be Earth's most customer centric company</p>
						<img src="view/images/section-seprator.png" alt="section-seprator" />
					</div><!-- Section Header /- -->
					<div class="col-md-6 col-sm-6 col-xs-6">
						<img src="view/images/about.jpg" alt="about" />
					</div>
					<div class="col-md-6 col-sm-6 col-xs-6">
						<div class="about-content">
							<h5>When you shop on <span>N4 Shop</span> you can assured about the quality of the products you're buying.</h5>
							...
							<ul>
								...
								<li>N4 Shop Provides Best Offers</li>
				...
				<div class="container">
					...
					<div class="col-md-3 col-sm-4 col-xs-6">
						<div class="team-detail">
							<div class="team-box">
								<img src="view/images/team-1.jpg" alt="team" />
								<h3>james Christ</h3>
							</div>
					...
					<div class="col-md-3 col-sm-4 col-xs-6">
						<div class="team-detail">
							<div class="team-box">
								<img src="view/images/team-2.jpg" alt="team" />
								<h3>jhon smith</h3>
							</div>
							<div class="team-content">
								<h5>Programmer</h5>
					...
					<div class="col-md-3 col-sm-4 col-xs-6">
						<div class="team-detail">
							<div class="team-box">
								<img src="view/images/team-3.jpg" alt="team" />
								<h3>jhon doe</h3>
							</div>
							<div class="team-content">
								<h5>Web Developer</h5>
					...
					<div class="col-md-3 col-sm-4 col-xs-6">
						<div class="team-detail">
							<div class="team-box">
								<img src="view/images/team-4.jpg" alt="team" />
								<h3>stuart max</h3>
							</div>
							<div class="team-content">
								<h5>Web Designer</h5>
						...
						<div role="listbox" class="carousel-inner">
							<div class="item active">
								<div class="testimonial-content">
									...
									<img src="view/images/testi.jpg" alt="testi" />
									<span class="star">
			...
			<div class="clients container-fluid">
				...
				<div class="container">
					<div class="clients-carousel">
						<div class="col-md-12 item"><a href="#" title="client"><img src="view/images/client-1.png" alt="client-1"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="view/images/client-2.png" alt="client-2"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="view/images/client-3.png" alt="client-3"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="view/images/client-4.png" alt="client-4"/></a></div>
						<div class="col-md-12 item"><a href="#" title="client"><img src="view/images/client-5.png" alt="client-5"/></a></div>
