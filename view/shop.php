							...
							<aside class="widget widget_latest_post">
								...
								<div class="latest-box">
									<div class="post-box">
										...
										<h5><a href="#" title="need N4 Shop.">I Phone 6s sales on</a></h5>
								...
								<div class="latest-box">
									<div class="post-box">
										...
										<h5><a href="#" title="need N4 Shop.">mens casual footwear</a></h5>
										<div class="star-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
								...
								<div class="latest-box">
									<div class="post-box">
										...
										<h5><a href="#" title="need N4 Shop.">running shoes</a></h5>
										<div class="star-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
