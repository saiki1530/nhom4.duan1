				...
				<div class="content-area blog-section col-md-8 col-sm-8 col-xs-12">
					<div class="type-post">
						<div class="col-md-5 col-sm-12 col-xs-12 no-padding entry-cover">
							<a href="blog-post.html"><img src="view/images/blog-1.jpg" alt="blog"></a>
					...
					<div class="type-post">
						<div class="col-md-5 col-sm-12 col-xs-12 no-padding entry-cover">
							<a href="blog-post.html"><img src="view/images/blog-2.jpg" alt="blog"></a>
							<span class="post-date"><a href="#"><i class="fa fa-calendar-o"></i>May 22</a></span>
						</div>
						<div class="col-md-7 col-sm-12 col-xs-12 blog-content">
							<h3 class="entry-title"><a title="Our shop visitor's new look" href="blog-post.html">Our shop visitor's <span>new look</span></a></h3>
							<div class="entry-meta">
								<span class="post-like"><a href="#" title="145 Likes"><i class="fa fa-heart-o"></i>145 Likes</a></span>
								<span class="post-admin"><i class="fa fa-user"></i>Posted By<a href="#" title="Max">Max</a></span>
							</div>
							<div class="entry-content">
								<p>The weather started getting rough - the tiny ship was tossed. If not for the courage of the fearless If not for the courage of the Minnow would be lost.</p>
					...
					<div class="type-post">
						<div class="col-md-5 col-sm-12 col-xs-12 no-padding entry-cover">
							<a href="blog-post.html"><img src="view/images/blog-3.jpg" alt="blog"></a>
							<span class="post-date"><a href="#"><i class="fa fa-calendar-o"></i>June 18</a></span>
						</div>
						<div class="col-md-7 col-sm-12 col-xs-12 blog-content">
							<h3 class="entry-title"><a title="buyers are saying it's good shop" href="blog-post.html">buyers are saying it's <span>good shop</span></a></h3>
							<div class="entry-meta">
					...
					<div class="type-post">
						<div class="col-md-5 col-sm-12 col-xs-12 no-padding entry-cover">
							<a href="blog-post.html"><img src="view/images/blog-4.jpg" alt="blog"></a>
							<span class="post-date"><a href="#"><i class="fa fa-calendar-o"></i>July 14	</a></span>
						</div>
						<div class="col-md-7 col-sm-12 col-xs-12 blog-content">
							<h3 class="entry-title"><a title="Happy Customers enjoying in the street" href="blog-post.html">Happy Customers <span>enjoying</span> in the street</a></h3>
							<div class="entry-meta">
								<span class="post-like"><a href="#" title="230 Likes"><i class="fa fa-heart-o"></i>230 Likes</a></span>
								<span class="post-admin"><i class="fa fa-user"></i>Posted By<a href="#" title="Max">Max</a></span>
							</div>
							<div class="entry-content">
								<p>The weather started getting rough - the tiny ship was tossed. If not for the courage of the fearless If not for the courage of the Minnow would be lost.</p>
					...
					<div class="type-post">
						<div class="col-md-5 col-sm-12 col-xs-12 no-padding entry-cover">
							<a href="blog-post.html"><img src="view/images/blog-5.jpg" alt="blog"></a>
							<span class="post-date"><a href="#"><i class="fa fa-calendar-o"></i>May 17</a></span>
						</div>
						<div class="col-md-7 col-sm-12 col-xs-12 blog-content">
							...
							<div class="entry-meta">
								<span class="post-like"><a href="#" title="120 Likes"><i class="fa fa-heart-o"></i>120 Likes</a></span>
								<span class="post-admin"><i class="fa fa-user"></i>Posted By<a href="#" title="Max">Max</a></span>
							</div>
							<div class="entry-content">
								<p>The weather started getting rough - the tiny ship was tossed. If not for the courage of the fearless If not for the courage of the Minnow would be lost.</p>
				...
				<div class="col-md-4 col-sm-4 col-xs-12 widget-area">
					...
					<aside class="widget widget_latest_post">
						...
						<div class="latest-box">
							<div class="post-box">
								<a href="#"><img src="view/images/latest-post-1.jpg" alt="Post"></a>
								<h5><a href="#" title="need N4 Shop.">need N4 Shop</a></h5>
						...
						<div class="latest-box">
							<div class="post-box">
								<a href="#"><img src="view/images/latest-post-2.jpg" alt="Post"></a>
						...
						<div class="latest-box">
							<div class="post-box">
								<a href="#"><img src="view/images/latest-post-3.jpg" alt="Post"></a>
								<h5><a href="#" title="chairs are beautiful">chairs are beautiful</a></h5>
								<span><a class="calendar" href="#"><i class="fa fa-calendar-o"></i>May 23, 2016</a><a href="#"><i class="fa fa-heart-o"></i> 224 Likes</a><a href="#">Posted By Max</a></span>
							</div>
						</div>
						...
						<div id="main-carousel1" class="carousel slide carousel-fade" data-ride="carousel">
							...
							<div role="listbox" class="carousel-inner">
								<div class="item active">
									...
									<p>N4 Shop - Creative Minimal Portfolio WordPress Theme by @ifathemes</p>
