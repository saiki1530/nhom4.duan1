...
if (isset($_POST['login'])) {
  ...
  $ret = mysqli_query($con, "SELECT * FROM user WHERE username='$username' and password='$password'and role=1");
  $num = mysqli_fetch_array($ret);
  if ($num > 0) {
    $extra = "view/manage-users.php";
...
<body>
  ...
  <script>
    $.backstretch("view/assets/img/login-bg.jpg", {
      speed: 500
    });
  </script>
