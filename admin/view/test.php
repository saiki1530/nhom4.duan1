...
if (strlen($_SESSION['id'] == 0)) {
   ...
   if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $msg = mysqli_query($con, "delete from vattu where id='$id'");
        if ($msg) {
                        ...
                        <div class="col-md-12">
                            <div class="content-panel">
                                <table class="table table-striped table-advance table-hover">
                                    <h4><i class="fa fa-angle-right"></i> Danh mục&nbsp; <a href="add-test.php"><svg xmlns="http://www.w3.org/2000/svg" style="color:aqua;" width="13" height="13" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                                    ...
                                    <tbody>
                                        <?php $ret = mysqli_query($con, "select * from vattu");
                                        $cnt = 1;
                                        while ($row = mysqli_fetch_array($ret)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <a href="update-test.php?id=<?php echo $row['id']; ?>">
